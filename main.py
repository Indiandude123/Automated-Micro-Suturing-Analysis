...
def generate_part2_csv(image_dir, input_csv_path, output_csv_file_name="output_csv2"):
    ...
    with open(input_csv_path, 'r') as csv_file:
        ...
        for row in csv_reader:
            ...
            with open(output_csv_path, "a") as csv_file:
                csv_writer = csv.writer(csv_file)
                csv_writer.writerow([img1_path, img2_path, output_distance, output_angle])
...
if __name__ == "__main__":
    ...
    if task == '1':
        ...
        print(input_path)
        generate_part2_csv(image_dir="test", input_csv_path=input_path, output_csv_file_name=output_csv)
